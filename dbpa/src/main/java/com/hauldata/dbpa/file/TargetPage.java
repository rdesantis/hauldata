...
public abstract class TargetPage {
	...
	interface Factory {
		 ...
		 */
		TargetPage create(File.Owner fileOwner, PageIdentifier id, FileOptions options, TargetHeaders headers) throws IOException;
		 ...
		 */
		TargetPage write(File.Owner fileOwner, PageIdentifier id, FileOptions options, TargetHeaders headers) throws IOException;
	}
