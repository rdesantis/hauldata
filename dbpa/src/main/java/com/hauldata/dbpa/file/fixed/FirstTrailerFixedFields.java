...
public class FirstTrailerFixedFields extends FixedFields {

	private List<ValidatorFixedField> validatorFields;

	public FirstTrailerFixedFields() {
	...
	public boolean matches(String record) {
		return validatorFields.stream().allMatch(field -> field.isExpectedIn(record));
	}
}
