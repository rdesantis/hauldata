...
public abstract class Node {
	...
	public static interface Factory {
		Node instantiate(Owner owner, Object key, PageOptions options);
		String getTypeName();
	}
	 ...
	 */
	public static Node getForCreate(Owner owner, Object key, Factory factory, PageOptions options) {
	 ...
	 * represented by the node and upon success call setOpen(true) on the node.
	 */
	public static Node getForWrite(Owner owner, Object key, Factory factory, PageOptions options) {
