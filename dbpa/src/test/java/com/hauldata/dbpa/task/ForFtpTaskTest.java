...
public class ForFtpTaskTest extends TaskTest {

	public ForFtpTaskTest(String name) {
		super(name);
	}

	public void testForFtp() throws Exception {

		String processId = "ForFtpTest";
		String script =
				"VARIABLES file_name VARCHAR END VARIABLES \n" +
				"TASK Loop FOR file_name FROM FTP '/root/staff/test/?PEP2_*.zip' \n" +
		...
		while (recordIterator.hasNext()) {
			...
			assertTrue(record.message.endsWith(".zip"));
		}
	}
}
